  ...
  <div class="results-games">
    <table>
      ...
      <tr>
        ...
        <td><a href="totalRed.php" style="font-size: 25px; cursor: pointer; text-decoration: none; color: black;">0</a></td>
        <td><a href="totalGreen.php" style="font-size: 25px; cursor: pointer; text-decoration: none; color: black;">0</a></td>
        <td><a href="totalYellow.php" style="font-size: 25px; cursor: pointer; text-decoration: none; color: black;">0</a></td>
        <td><a href="totalBlue.php" style="font-size: 25px; cursor: pointer; text-decoration: none; color: black;">0</a></td>
      </tr>
    </table>
  </div>
